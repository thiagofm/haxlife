(defproject haxlife "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "haxlife.core/on-figwheel-reload"}

                :compiler {:main haxlife.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/haxlife.js"
